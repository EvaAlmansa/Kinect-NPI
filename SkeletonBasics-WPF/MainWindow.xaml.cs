...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// <summary>
        /// Detecting move of left hand to shoulder XY
        /// </summary>
        ...
        private void DrawBone(Skeleton skeleton, DrawingContext drawingContext, JointType jointType0, JointType jointType1)
        {
            ...
            {
                if (moveLeftHandtoShoulderXY.detectingSkeleton(skeleton))
                {
            ...
            if(moveLeftHandtoShoulderXY.position0())
            {
                //position0.Foreground = new SolidColorBrush(Colors.Green);
            }
        }
